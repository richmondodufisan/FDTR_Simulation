...
#SBATCH --nodes=13 ## how many computers do you need
...
#SBATCH --mem-per-cpu=430M ## how much RAM do you need per CPU (this effects your FairShare score so be careful to not ask for more than you need))
#SBATCH --job-name=-15175  ## When you run squeue -u NETID this is how you can identify the job


script_name="FDTR_input_theta_75_freq_1e6_x0_-15.i"
