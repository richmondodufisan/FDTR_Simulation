...
#SBATCH --time=0:15:00 ## how long does this need to run (remember different partitions have restrictions on this param)
...
#SBATCH --job-name=t30  ## When you run squeue -u NETID this is how you can identify the job


script_name="FDTR_input_theta_30_freq_10e6_x0_15.i"
